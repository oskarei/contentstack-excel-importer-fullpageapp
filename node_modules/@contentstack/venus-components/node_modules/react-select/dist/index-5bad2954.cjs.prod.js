...
var _extends = require("@babel/runtime/helpers/extends"), core = require("@emotion/core"), _css = require("@emotion/css"), _taggedTemplateLiteralLoose = require("@babel/runtime/helpers/taggedTemplateLiteralLoose"), _objectWithoutPropertiesLoose = require("@babel/runtime/helpers/objectWithoutPropertiesLoose"), AutosizeInput = require("react-input-autosize"), _inheritsLoose = require("@babel/runtime/helpers/inheritsLoose"), React = require("react"), ReactDOM = require("react-dom");
...
var _extends__default = _interopDefault(_extends), _css__default = _interopDefault(_css), _taggedTemplateLiteralLoose__default = _interopDefault(_taggedTemplateLiteralLoose), _objectWithoutPropertiesLoose__default = _interopDefault(_objectWithoutPropertiesLoose), AutosizeInput__default = _interopDefault(AutosizeInput), _inheritsLoose__default = _interopDefault(_inheritsLoose), noop = function() {};
...
var coercePlacement = function(p) {
  ...
  function MenuPlacer() {
    ...
    return (_this = _Component.call.apply(_Component, [ this ].concat(args)) || this).state = {
      ...
      return _extends__default.default({}, _this.props, {
        placement: placement,
        maxHeight: _this.state.maxHeight
      });
    }, _this;
  }
  return _inheritsLoose__default.default(MenuPlacer, _Component), MenuPlacer.prototype.render = function() {
...
}, Menu$1 = Menu, menuListCSS = function(_ref4) {
...
var menuPortalCSS = function(_ref6) {
  ...
  return _inheritsLoose__default.default(MenuPortal, _Component2), MenuPortal.prototype.render = function() {
...
}, _excluded$2 = [ "size" ], _ref2 = {
  name: "19bqh2r",
  styles: "display:inline-block;fill:currentColor;line-height:1;stroke:currentColor;stroke-width:0;"
}, Svg = function(_ref) {
  var size = _ref.size, props = _objectWithoutPropertiesLoose__default.default(_ref, _excluded$2);
...
}, loadingDotAnimations = core.keyframes(_templateObject || (_templateObject = _taggedTemplateLiteralLoose__default.default([ "\n  0%, 80%, 100% { opacity: 0; }\n  40% { opacity: 1; }\n" ]))), loadingIndicatorCSS = function(_ref5) {
...
var css$1 = function(_ref) {
...
}, Control$1 = Control, _excluded$1 = [ "className", "cx", "getStyles", "theme", "selectProps" ], groupCSS = function(_ref) {
  ...
  props.selectProps;
  var cleanProps = _objectWithoutPropertiesLoose__default.default(props, _excluded$1);
  return core.jsx("div", _extends__default.default({
    css: getStyles("groupHeading", _extends__default.default({
      theme: theme
    }, cleanProps)),
    className: cx({
      "group-heading": !0
...
}, Group$1 = Group, _excluded = [ "className", "cx", "getStyles", "innerRef", "isHidden", "isDisabled", "theme", "selectProps" ], inputCSS = function(_ref) {
  ...
  return core.jsx("div", {
    css: getStyles("input", _extends__default.default({
      theme: theme
    }, props))
...
}, Input$1 = Input, multiValueCSS = function(_ref) {
...
var MultiValue = function(props) {
  ...
  return core.jsx(core.ClassNames, null, function(_ref6) {
    ...
    return core.jsx(Container, {
      data: data,
      innerProps: _extends__default.default({}, innerProps, {
      ...
      data: data,
      innerProps: _extends__default.default({
...
var MultiValue$1 = MultiValue, optionCSS = function(_ref) {
...
}, Option$1 = Option, placeholderCSS = function(_ref) {
...
}, Placeholder$1 = Placeholder, css = function(_ref) {
  var isDisabled = _ref.isDisabled, _ref$theme = _ref.theme, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
  return {
    label: "singleValue",
...
}, SingleValue$1 = SingleValue, components = {
  ...
  return _extends__default.default({}, components, props.components);
};
...
exports.containerCSS = containerCSS, exports.css = css$1, exports.css$1 = css, exports.defaultComponents = defaultComponents, 
