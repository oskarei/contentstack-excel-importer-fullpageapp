      ...
      var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee5(data) {
        ...
        return _regeneratorRuntime.wrap(function (_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              api_version = _args5.length > 1 && _args5[1] !== undefined ? _args5[1] : '';
              params = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : {};
              _context5.prev = 1;
              branch = params.branch, queryParams = _objectWithoutProperties(params, _excluded);
              headers = {
              ...
              _context5.next = 2;
              return http.post("".concat(this.urlPath, "/publish"), data, headers);
            case 2:
