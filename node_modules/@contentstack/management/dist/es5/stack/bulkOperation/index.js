...
var _excluded = ["api_version"];
exports.BulkOperation = BulkOperation;
var _regenerator = require("@babel/runtime/regenerator");
var _regenerator2 = (0, _interopRequireDefault2["default"])(_regenerator);
var _cloneDeep2 = require("lodash/cloneDeep");
var _cloneDeep3 = (0, _interopRequireDefault2["default"])(_cloneDeep2);
...
function BulkOperation(http) {
      ...
      return _regenerator2["default"].wrap(function (_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            headers = {
              headers: _objectSpread({}, (0, _cloneDeep3["default"])(_this.stackHeaders))
            }; // eslint-disable-next-line camelcase
   ...
   */
  // eslint-disable-next-line camelcase
  this.getJobItems = /*#__PURE__*/function () {
    var _ref7 = (0, _asyncToGenerator3["default"])(/*#__PURE__*/_regenerator2["default"].mark(function _callee4(job_id) {
      var params,
        _cloneDeep,
        _cloneDeep$api_versio,
        api_version,
        queryParams,
        headers,
        response,
      ...
      return _regenerator2["default"].wrap(function (_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            // eslint-disable-next-line camelcase
            _cloneDeep = (0, _cloneDeep3["default"])(params), _cloneDeep$api_versio = _cloneDeep.api_version, api_version = _cloneDeep$api_versio === void 0 ? '3.2' : _cloneDeep$api_versio, queryParams = (0, _objectWithoutProperties3["default"])(_cloneDeep, _excluded); // eslint-disable-next-line camelcase
            _this.urlPath = "/bulk/jobs/".concat(job_id, "/items");
            headers = {
              headers: _objectSpread({}, (0, _cloneDeep3["default"])(_this.stackHeaders))
            }; // eslint-disable-next-line camelcase
            if (api_version) headers.headers.api_version = api_version;
  ...
  this.publish = /*#__PURE__*/function () {
    var _ref9 = (0, _asyncToGenerator3["default"])(/*#__PURE__*/_regenerator2["default"].mark(function _callee5(_ref8) {
      var details, _ref8$skip_workflow_s, skip_workflow_stage, _ref8$approvals, approvals, _ref8$is_nested, is_nested, _ref8$api_version, api_version, _ref8$publishAllLocal, publishAllLocalized, httpBody, headers;
      return _regenerator2["default"].wrap(function (_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            details = _ref8.details, _ref8$skip_workflow_s = _ref8.skip_workflow_stage, skip_workflow_stage = _ref8$skip_workflow_s === void 0 ? false : _ref8$skip_workflow_s, _ref8$approvals = _ref8.approvals, approvals = _ref8$approvals === void 0 ? false : _ref8$approvals, _ref8$is_nested = _ref8.is_nested, is_nested = _ref8$is_nested === void 0 ? false : _ref8$is_nested, _ref8$api_version = _ref8.api_version, api_version = _ref8$api_version === void 0 ? '' : _ref8$api_version, _ref8$publishAllLocal = _ref8.publishAllLocalized, publishAllLocalized = _ref8$publishAllLocal === void 0 ? false : _ref8$publishAllLocal;
            httpBody = {};
            if (details) {
              httpBody = (0, _cloneDeep3["default"])(details);
            }
            headers = {
              headers: _objectSpread({}, (0, _cloneDeep3["default"])(_this.stackHeaders))
            }; // eslint-disable-next-line camelcase
            ...
            // eslint-disable-next-line camelcase
            if (api_version) headers.headers.api_version = api_version;
            return _context5.abrupt("return", (0, _entity.publishUnpublish)(http, '/bulk/publish', httpBody, headers));
          case 1:
          case "end":
  ...
  this.unpublish = /*#__PURE__*/function () {
    var _ref1 = (0, _asyncToGenerator3["default"])(/*#__PURE__*/_regenerator2["default"].mark(function _callee6(_ref0) {
      var details, _ref0$skip_workflow_s, skip_workflow_stage, _ref0$approvals, approvals, _ref0$is_nested, is_nested, _ref0$api_version, api_version, _ref0$unpublishAllLoc, unpublishAllLocalized, httpBody, headers;
      return _regenerator2["default"].wrap(function (_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            details = _ref0.details, _ref0$skip_workflow_s = _ref0.skip_workflow_stage, skip_workflow_stage = _ref0$skip_workflow_s === void 0 ? false : _ref0$skip_workflow_s, _ref0$approvals = _ref0.approvals, approvals = _ref0$approvals === void 0 ? false : _ref0$approvals, _ref0$is_nested = _ref0.is_nested, is_nested = _ref0$is_nested === void 0 ? false : _ref0$is_nested, _ref0$api_version = _ref0.api_version, api_version = _ref0$api_version === void 0 ? '' : _ref0$api_version, _ref0$unpublishAllLoc = _ref0.unpublishAllLocalized, unpublishAllLocalized = _ref0$unpublishAllLoc === void 0 ? false : _ref0$unpublishAllLoc;
            httpBody = {};
            if (details) {
              httpBody = (0, _cloneDeep3["default"])(details);
            }
            ...
            return _context6.abrupt("return", (0, _entity.publishUnpublish)(http, '/bulk/unpublish', httpBody, headers));
          case 1:
          case "end":
   ...
   *
   */
  this["delete"] = /*#__PURE__*/(0, _asyncToGenerator3["default"])(/*#__PURE__*/_regenerator2["default"].mark(function _callee7() {
    var params,
      httpBody,
      headers,
      _args7 = arguments;
    return _regenerator2["default"].wrap(function (_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          httpBody = {};
          if (params.details) {
            httpBody = (0, _cloneDeep3["default"])(params.details);
          }
          headers = {
            headers: _objectSpread({}, (0, _cloneDeep3["default"])(_this.stackHeaders))
          };
          return _context7.abrupt("return", (0, _entity.publishUnpublish)(http, '/bulk/delete', httpBody, headers));
        case 1:
        case "end":
   ...
   *
   */
  this.update = /*#__PURE__*/(0, _asyncToGenerator3["default"])(/*#__PURE__*/_regenerator2["default"].mark(function _callee8() {
    var updateBody,
      headers,
      _args8 = arguments;
    return _regenerator2["default"].wrap(function (_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          updateBody = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : {};
          headers = {
            headers: _objectSpread({}, (0, _cloneDeep3["default"])(_this.stackHeaders))
          };
          return _context8.abrupt("return", (0, _entity.publishUnpublish)(http, '/bulk/workflow', updateBody, headers));
        case 1:
        case "end":
