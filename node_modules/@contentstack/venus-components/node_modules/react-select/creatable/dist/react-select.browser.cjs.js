...
var base_dist_reactSelect = require('../../dist/Select-acd252b1.browser.cjs.js');
var index = require('../../dist/index-dacc4246.browser.cjs.js');
var stateManager = require('../../dist/stateManager-b3381797.browser.cjs.js');
...
var defaultProps = _extends__default["default"]({
  allowCreateWhileLoading: false,
  createOptionPosition: 'last'
}, builtins);
var makeCreatableSelect = function makeCreatableSelect(SelectComponent) {
  var _Creatable;
  return _Creatable = /*#__PURE__*/function (_Component) {
      ...
      _this.onChange = function (newValue, actionMeta) {
        ...
        if (valueArray[valueArray.length - 1] === newOption) {
          if (onCreateOption) onCreateOption(inputValue);else {
            ...
            if (isMulti) {
              onChange([].concat(index.cleanValue(value), [newOptionData]), newActionMeta);
            } else {
    ...
    _inheritsLoose__default["default"](Creatable, _Component);
    ...
    return Creatable;
  }(React.Component), _Creatable.defaultProps = defaultProps, _Creatable;
};
