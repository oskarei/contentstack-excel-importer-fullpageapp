...
function contentstackHttpClient(options) {
    ...
    logHandler: function logHandler(level, data) {
      if (level === 'error' && data != null && data !== '') {
        ...
        if (typeof data === 'string') {
          ...
          title = [data.name, data.message].filter(function (a) {
            return a;
          }).join(' - ');
          if (!title && (0, _typeof3["default"])(data) === 'object' && data.code) {
  ...
  developerHubBaseUrl = (_developerHubBaseUrl = developerHubBaseUrl) === null || _developerHubBaseUrl === void 0 ? void 0 : _developerHubBaseUrl.replace('api', 'developerhub-api').replace(/^dev11/, 'dev') // dev11 maps to 'dev' (special case from DeveloperHub team; other devN environments keep their number)
