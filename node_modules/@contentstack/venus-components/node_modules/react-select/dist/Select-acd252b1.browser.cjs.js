...
var index = require('./index-dacc4246.browser.cjs.js');
...
var _excluded$2 = ["in", "out", "onExited", "appear", "enter", "exit", "innerRef", "emotion"];
...
var ScrollBlock = /*#__PURE__*/function (_PureComponent) {
  ...
  _inheritsLoose__default["default"](ScrollBlock, _PureComponent);
...
var instructionsAriaMessage = function instructionsAriaMessage(event, context) {
  ...
  var _context = context,
    ...
    tabSelectsValue = _context.tabSelectsValue;
  switch (event) {
    case 'menu':
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  _proto.onMenuClose = function onMenuClose() {
    var _this$props0 = this.props,
      isSearchable = _this$props0.isSearchable,
      isMulti = _this$props0.isMulti;
...
;
  ...
  _proto.openMenu = function openMenu(focusOption) {
    ...
    var _this$props1 = this.props,
      isMulti = _this$props1.isMulti,
      tabSelectsValue = _this$props1.tabSelectsValue;
  ...
  _proto.getTheme = function getTheme() {
    ...
    return _extends__default["default"]({}, defaultTheme, this.props.theme);
  };
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          item.type;
            var group = _objectWithoutPropertiesLoose__default["default"](item, _excluded);
    ...
    var menuElement = /*#__PURE__*/React__default["default"].createElement(index.MenuPlacer, _extends__default["default"]({}, commonProps, menuPlacementProps), function (_ref8) {
      var ref = _ref8.ref,
  ...
  _proto.renderLiveRegion = function renderLiveRegion() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(A11yText$1, {
      "aria-live": "polite"
