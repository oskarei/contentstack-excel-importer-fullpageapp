...
function foldNestedListSiblingsIntoPreviousLi(children) {
    ...
    for (var i = 0; i < children.length; i++) {
        var node = children[i];
        var isList = node && (node.type === NodeType$1.ORDER_LIST || node.type === NodeType$1.UNORDER_LIST);
        var last = result[result.length - 1];
        var lastIsLi = last && last.type === NodeType$1.LIST_ITEM;
...
function referenceToHTML(node, renderOption, renderEmbed) {
    ...
    var metadata = nodeToMetadata(node.attrs, (((_a = node.children) === null || _a === void 0 ? void 0 : _a.length) > 0 ? node.children[0] : {}));
 ...
 */
function addTags(entry, contentTypeUid, tagsAsObject, locale, options) {
    var _a;
...
function findRTEField(fieldData) {
    if (fieldData === null || fieldData === void 0 ? void 0 : fieldData.embedded_itemsConnection) {
        return fieldData;
    }
...
function getVariantAliases(entryOrEntries, contentTypeUid) {
 ...
 */
function getVariantMetadataTags(entries, contentTypeUid) {
...
exports.getVariantAliases = getVariantAliases;
exports.getVariantMetadataTags = getVariantMetadataTags;
