...
var loadingDotAnimations = keyframes(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  0%, 80%, 100% { opacity: 0; }\n  40% { opacity: 1; }\n"])));
...
var GroupHeading = function GroupHeading(props) {
  var className = props.className,
    ...
    theme = props.theme;
    props.selectProps;
    var cleanProps = _objectWithoutPropertiesLoose(props, _excluded$1);
  return jsx("div", _extends({
