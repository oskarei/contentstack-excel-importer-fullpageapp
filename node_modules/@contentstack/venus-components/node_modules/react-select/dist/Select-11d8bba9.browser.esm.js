...
;
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          item.type;
            var group = _objectWithoutPropertiesLoose(item, _excluded);
    ...
    var menuElement = /*#__PURE__*/React.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function (_ref8) {
      var ref = _ref8.ref,
  ...
  _proto.renderLiveRegion = function renderLiveRegion() {
    ...
    return /*#__PURE__*/React.createElement(A11yText$1, {
      "aria-live": "polite"
