(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('stylis')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'stylis'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactStyleTag = {}, global.React, global.ReactDOM, global.stylis));
})(this, (function (exports, react, reactDom, stylis) { 'use strict';
  ...
  function getProcessedStyles(style, options) {
    var compiled = stylis.compile(style);
    var enhancer = options.isPrefixed ? stylis.middleware([stylis.prefixer, stylis.stringify]) : stylis.stringify;
    return stylis.serialize(compiled, enhancer);
  }
  /**
  ...
  function useStyle(children, options) {
    var childrenRef = react.useRef(children);
  ...
  var Link = /*#__PURE__*/react.forwardRef(function LinkTag(_ref, ref) {
    var passedProps = _ref.passedProps,
        style = _ref.style;
    var getCachedLinkHref = react.useMemo(createGetCachedLinkHref, []);
    return /*#__PURE__*/react.createElement('link', Object.assign({}, passedProps, {
      href: getCachedLinkHref(style),
      rel: 'stylesheet',
      ref: ref
    }));
  });
  var Style = /*#__PURE__*/react.forwardRef(function Style(props, ref) {
    ...
    if (options.hasSourceMap) {
      return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/react.createElement(Link, {
    ...
    return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/react.createElement('style', Object.assign({}, passedProps, {
      ref: ref
    }), style), document.head);
  });
