export declare const jsx: <S extends "anchor" | "text" | "editor" | "focus" | "element" | "cursor" | "selection" | "fragment">(tagName: S, attributes?: Object, ...children: any[]) => ReturnType<({
...
export declare const addSocialEmbedTest: {
    input: any;
    output: any;
};
export declare const addSocialEmbedTestIframe: {
    input: any;
    output: any;
};
