...
var _extends = require("@babel/runtime/helpers/extends"), _inheritsLoose = require("@babel/runtime/helpers/inheritsLoose"), React = require("react"), memoizeOne = require("memoize-one"), index = require("./index-5bad2954.cjs.prod.js"), _css = require("@emotion/css"), core = require("@emotion/core"), ReactDOM = require("react-dom");
...
for (var _objectWithoutPropertiesLoose__default = _interopDefault(_objectWithoutPropertiesLoose), _extends__default = _interopDefault(_extends), _inheritsLoose__default = _interopDefault(_inheritsLoose), React__default = _interopDefault(React), memoizeOne__default = _interopDefault(memoizeOne), _css__default = _interopDefault(_css), ReactDOM__default = _interopDefault(ReactDOM), diacritics = [ {
  base: "A",
...
var stripDiacritics = function(str) {
  ...
  return function(option, rawInput) {
    var _ignoreCase$ignoreAcc = _extends__default.default({
      ignoreCase: !0,
      ignoreAccents: !0,
...
}, A11yText$1 = A11yText, _excluded$2 = [ "in", "out", "onExited", "appear", "enter", "exit", "innerRef", "emotion" ];

function DummyInput(_ref) {
  _ref.in, _ref.out, _ref.onExited, _ref.appear, _ref.enter, _ref.exit;
  var innerRef = _ref.innerRef;
  _ref.emotion;
  var props = _objectWithoutPropertiesLoose__default.default(_ref, _excluded$2);
...
var NodeResolver = function(_Component) {
  ...
  _inheritsLoose__default.default(NodeResolver, _Component);
  var _proto = NodeResolver.prototype;
  return _proto.componentDidMount = function() {
    ReactDOM__default.default.findDOMNode ? this.props.innerRef(ReactDOM__default.default.findDOMNode(this)) : this.props.innerRef(ReactDOM__default.default.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE.findDOMNode(this));
...
var canUseDOM = !("undefined" == typeof window || !window.document || !window.document.createElement), activeScrollLocks = 0, ScrollLock = function(_Component) {
  ...
  _inheritsLoose__default.default(ScrollLock, _Component);
...
var _ref = {
  ...
  return _inheritsLoose__default.default(ScrollBlock, _PureComponent), ScrollBlock.prototype.render = function() {
...
}(React.PureComponent), _excluded$1 = [ "isEnabled" ], ScrollCaptor = function(_Component) {
  ...
  _inheritsLoose__default.default(ScrollCaptor, _Component);
...
function ScrollCaptorSwitch(_ref) {
  var _ref$isEnabled = _ref.isEnabled, isEnabled = void 0 === _ref$isEnabled || _ref$isEnabled, props = _objectWithoutPropertiesLoose__default.default(_ref, _excluded$1);
...
var instructionsAriaMessage = function(event, context) {
  ...
  var _context = context, isSearchable = _context.isSearchable, isMulti = _context.isMulti, label = _context.label, isDisabled = _context.isDisabled, tabSelectsValue = _context.tabSelectsValue;
  switch (event) {
   case "menu":
...
function mergeStyles(source, target) {
  ...
  var styles = _extends__default.default({}, source);
...
var colors = {
  ...
  function Select(_props) {
    ...
    _this.controlRef = null, _this.getControlRef = function(ref) {
      ...
      onChange(newValue, _extends__default.default({}, actionMeta, {
        name: name
      }));
      ...
      _this.setState({
        ariaLiveContext: instructionsAriaMessage(event, _extends__default.default({}, context, {
    ...
    _this.cacheComponents = memoizeOne__default.default(_this.cacheComponents, index.exportedEqual).bind(_this), 
    ...
    _this.buildMenuOptions = memoizeOne__default.default(_this.buildMenuOptions, function(newArgs, lastArgs) {
      var _ref6 = newArgs, newProps = _ref6[0], newSelectValue = _ref6[1], _ref7 = lastArgs, lastProps = _ref7[0];
      return newSelectValue === _ref7[1] && newProps.inputValue === lastProps.inputValue && newProps.options === lastProps.options;
    }).bind(_this);
  ...
  _inheritsLoose__default.default(Select, _Component);
  ...
  return _proto.componentDidMount = function() {
    ...
    var _this$props0 = this.props, isSearchable = _this$props0.isSearchable, isMulti = _this$props0.isMulti;
    ...
    var _this2 = this, _this$state3 = this.state, selectValue = _this$state3.selectValue, isFocused = _this$state3.isFocused, menuOptions = this.buildMenuOptions(this.props, selectValue), _this$props1 = this.props, isMulti = _this$props1.isMulti, tabSelectsValue = _this$props1.tabSelectsValue, openAtIndex = "first" === focusOption ? 0 : menuOptions.focusable.length - 1;
    if (!isMulti) {
    ...
    var _this$props10 = this.props, isMulti = _this$props10.isMulti, isSearchable = _this$props10.isSearchable, _this$state4 = this.state, selectValue = _this$state4.selectValue, focusedValue = _this$state4.focusedValue;
    if (isMulti) {
      this.setState({
        focusedOption: null
      });
    ...
    var _this$props11 = this.props, pageSize = _this$props11.pageSize, tabSelectsValue = _this$props11.tabSelectsValue, _this$state5 = this.state, focusedOption = _this$state5.focusedOption, options = _this$state5.menuOptions.focusable;
    if (options.length) {
    ...
    return this.props.theme ? "function" == typeof this.props.theme ? this.props.theme(defaultTheme) : _extends__default.default({}, defaultTheme, this.props.theme) : defaultTheme;
    ...
    if (isMulti) {
      var selectValues = selectValue.map(function(opt, index) {
        ...
        return React__default.default.createElement(MultiValue, _extends__default.default({}, commonProps, {
          ...
          isDisabled: isDisabled,
          key: "" + _this4.getOptionValue(opt) + index,
          index: index,
          removeProps: {
            onClick: function() {
    ...
    if (this.hasOptions()) menuUI = menuOptions.render.map(function(item) {
      if ("group" === item.type) {
        item.type;
        var group = _objectWithoutPropertiesLoose__default.default(item, _excluded), headingId = item.key + "-heading";
    ...
    }, menuElement = React__default.default.createElement(index.MenuPlacer, _extends__default.default({}, commonProps, menuPlacementProps), function(_ref8) {
    ...
    return this.state.isFocused ? React__default.default.createElement(A11yText$1, {
      "aria-live": "polite"
