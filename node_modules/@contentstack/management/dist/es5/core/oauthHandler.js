...
var _pkceStorage = require("./pkceStorage");
...
var OAuthHandler = /*#__PURE__*/function () {
  function OAuthHandler(axiosInstance, appId, clientId, redirectUri, clientSecret) {
    ...
    if (!this.clientSecret) {
      var stored = (0, _pkceStorage.getStoredCodeVerifier)(this.appId, this.clientId, this.redirectUri);
      if (stored) {
        this.codeVerifier = stored;
      } else {
        this.codeVerifier = this.generateCodeVerifier();
        (0, _pkceStorage.storeCodeVerifier)(this.appId, this.clientId, this.redirectUri, this.codeVerifier);
      }
        ...
        return _regenerator2["default"].wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              (0, _pkceStorage.clearStoredCodeVerifier)(this.appId, this.clientId, this.redirectUri); // Clear immediately after successful exchange to prevent replay
              return _context3.abrupt("return", response.data);
            case 3:
              _context3.prev = 3;
              _t2 = _context3["catch"](1);
              (0, _pkceStorage.clearStoredCodeVerifier)(this.appId, this.clientId, this.redirectUri); // Clear on error to prevent replay attacks
